...
since only one keyword is supported, one would need to type in `llmfq` (or some other keyword) then
...
<img src="https://i.imgur.com/vTj2Pn2.png" width="50%" alt="Bard details">
<img src="https://i.imgur.com/FTKMoE6.png" width="50%" alt="ChatGPT details">
